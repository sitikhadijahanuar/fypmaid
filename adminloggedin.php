            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
						...
						<a href="view_registration.php" class="nav-item nav-link">Registered User</a>
...
if (!isset($_SESSION['admin_id'])) {
	...
	// Need the functions:
	require ('includes/adminlogin_functions.inc.php');
	redirect_user();	
...
echo "<br> <br> <br> <br> <br> <br> <br> <br><h1><center> Logged In </center></h1>
<p><center>Welcome, {$_SESSION['username']}! </center></p>";
