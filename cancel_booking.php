...
<body style="background-color:#4A546B;">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (empty($errors)) {
            ...
            if ($test) { // If it ran OK.

                // Print a message:
                echo '<br> <br> <br> <br> <br> <br> <br><h1><center> Thank you </center></h1>
			<p><center> Your booking has been successfully cancelled! </center></p><p><br /></p>';
                ...
                <div class="col-10 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-4">
                            <h2 class="mb-4 pb-2 pb-md-0 mb-md-5 col text-center">Booking History</h2>
                                ...
                                <div class="col text-center">
                                    <div class="mt-15 pt-15">
                                         <a href="delete_user.php?register_id=<?php echo $_SESSION['register_id'];?>"><button  class="btn btn-primary btn-lg">Cancel booking</button></a>
                                    </div>
                                </div>                          
                        </div>
                    </div>
