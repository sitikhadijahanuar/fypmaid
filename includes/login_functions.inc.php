...
function check_login($dbc, $username = '', $password = '') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Retrieve the register_id for that username/password combination:
		$q = "SELECT register_id, username, password FROM registration WHERE username='$username' AND password=('$password')";		
